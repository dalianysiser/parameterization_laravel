...
<main class="w-full flex-grow p-6">
    <div class="flex justify-between items-center pb-6">
        <h1 class="text-3xl text-black">New Type Combo Information</h1>
    ...
    <div class="flex flex-wrap">
        <div class="w-full my-6">
            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('typeComboInformation.store')}}">
                @csrf
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="detail_type_information_id" class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded focus:outline-none focus:bg-white">
                                @foreach ($detailTypeInformation as $detail)            
