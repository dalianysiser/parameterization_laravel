...
<main class="w-full flex-grow p-6">
    <div class="flex justify-between items-center pb-6">
        <h1 class="text-3xl text-black">New Type Information</h1>
    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{route('typeInformation.store')}}">
                @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_singleRegistry" class="mr-2 leading-tight">
                                <span class="text-gray-700">Single Registry</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" class="mr-2 leading-tight">
